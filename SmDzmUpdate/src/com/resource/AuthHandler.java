    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        if (outboundProperty) {
            try {
                ...
                usernameTokenElement.addChildElement("Username", "wsse").addTextNode(USERNAME);
                usernameTokenElement.addChildElement("Password", "wsse").addTextNode(PASSWORD);
            ...
            try {
                ...
                Iterator<?> securityHeaders = soapHeader.getChildElements(
