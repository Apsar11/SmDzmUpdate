 ...
 * 
 */
@WebServiceClient(name = "CarService", targetNamespace = "http://resource.com", wsdlLocation = "http://localhost:8080/SmDzmUpdate/services/Car?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CARSERVICE_QNAME = new QName("http://resource.com", "CarService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SmDzmUpdate/services/Car?wsdl");
     ...
     *     returns Car
     */
    @WebEndpoint(name = "Car")
    public Car getCar() {
        return super.getPort(new QName("http://resource.com", "Car"), Car.class);
    }
     ...
     */
    @WebEndpoint(name = "Car")
    public Car getCar(WebServiceFeature... features) {
        return super.getPort(new QName("http://resource.com", "Car"), Car.class, features);
    }
